...
public class Main {
	...
	public static void main(String[] args) {
		cotxe = new Cotxe("Serie 2 220iA", "184cv"); // La marca està ja inicialitzada anteriorment ja que és static i final. La potència s'inicialitza a dins del constructor quan es crea la instància.
